...
export class ForgotPassword extends React.Component {
      ...
      async handleEmailReset() {
            ...
            await api.post('dev/forgotpassword', data)
                  .then((response) => {
                        notify(`An email with instructions was sent to you, please check your inbox!`, '✔️', 'success', 'top-right');
                  })
                  .catch((err) => {
                  ...
                  <div className='forgotpassword-container' >
                        <section className='form'>
                              ...
                              <form>
                                    ...
                                    <Button color='primary' disabled={this.state.disableBtn} className='button' type='button'
